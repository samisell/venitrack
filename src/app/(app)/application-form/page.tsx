        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                ...
                <div className="md:col-span-2">
                    <Label>Passport Data Page (PDF/JPG) *</Label>
                    <FileUploadButton label="Upload Passport" />
                </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                ...
                />
                <div className="space-y-2"><Label>Academic Certificates *</Label><FileUploadButton label="Upload Certificate"/></div>
                <div className="space-y-2"><Label>Academic Transcripts *</Label><FileUploadButton label="Upload Transcript"/></div>
            </CardContent>
          </Card>
