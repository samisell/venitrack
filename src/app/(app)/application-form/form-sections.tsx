...
import { ApplicationFormValues } from './schema'; // Ensure schema.ts is in the same directory
import {
    FormControl,
    FormDescription,
    FormField,
...
export function PersonalInformation({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input placeholder="Country you live in" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            <FormControl>
                                <Input type="email" readOnly placeholder="student@example.com" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
...
export function StudyPreferences({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Intended Country/Countries of Study *</FormLabel>
                            <FormControl>
                                <Input placeholder="e.g., Canada, USA" {...field} />
                            </FormControl>
                            <FormDescription>You can list multiple countries, separated by commas.</FormDescription>
                            <FormMessage />
                        </FormItem>
                    )}
                />
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Preferred Institution(s)</FormLabel>
                            <FormControl>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Intended Level of Study *</FormLabel>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                    <SelectTrigger>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Intended Course / Program *</FormLabel>
                            <FormControl>
                ...
                <FormField
                    control={control}
                    name="appliedBeforeDetails"
                    render={({ field }) => (
                        <FormItem className="md:col-span-2">
                            <FormLabel>If yes, list schools and outcomes</FormLabel>
                            <FormControl>
                                <Textarea placeholder="e.g., McGill University - Admitted, University of British Columbia - Pending" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
...
export function AcademicBackground({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Highest Qualification Obtained *</FormLabel>
                            <FormControl>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Grade / GPA / Class of Degree *</FormLabel>
                            <FormControl>
                                <Input placeholder="e.g., 4.5/5.0, First Class" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <div className="md:col-span-2">
                    <FileUploadButton label="Academic Transcripts (PDF/JPG) *" />
                </div>
            </CardContent>
        </Card>
    );
...
export function EnglishProficiency({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Have you taken an English proficiency test?</FormLabel>
                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                <FormControl>
                                    <SelectTrigger>
...
export function WorkExperience({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
...
export function FinancialInformation({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-2">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Sponsor Full Name *</FormLabel>
                            <FormControl>
                                <Input {...field} />
                            </FormControl>
                            <FormMessage />
...
export function StatementIntent({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-1">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Why do you want to study this course and country?</FormLabel>
                            <FormControl>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Career goals after graduation</FormLabel>
                            <FormControl>
                                <Textarea rows={4} {...field} />
                            </FormControl>
                            <FormMessage />
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>If yes, explain briefly</FormLabel>
                            <FormControl>
                                <Textarea {...field} />
                            </FormControl>
                            <FormMessage />
...
export function MedicalBackground({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
...
export function AdditionalInformation({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
            ...
            <CardContent className="grid gap-6 md:grid-cols-1">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel>Notes or comments for counselor</FormLabel>
                            <FormControl>
                                <Textarea {...field} />
                            </FormControl>
                            <FormMessage />
...
export function DeclarationConsent({ control }: SectionProps) {
    return (
        <Card>
            <CardHeader>
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                                <FormLabel>I authorize the counselor to process my application.</FormLabel>
                            </div>
                            <FormMessage />
                        </FormItem>
                    )}
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-md border p-4">
                            ...
                            <div className="space-y-1 leading-none">
                                <FormLabel>I consent to document verification and communication via email/WhatsApp.</FormLabel>
                            </div>
                            <FormMessage />
                        </FormItem>
                    )}
